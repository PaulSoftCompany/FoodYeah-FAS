...
import com.paulsoft.inventory.Util;
...
public class S1Steps {
    ...
    public void theApplicationShowsTheDescriptionOfEachDish() {
    ...
    public void theApplicationHasToShowTheDishesByDates() {
        ProductDto mapped =  convertToResource(PRODUCT);
        try {
            Assert.assertNotNull("RESPONSE NOT NULL",responseAll);
        }catch(AssertionError e){
    ...
    public void theApplicationRefreshTheWeeklyMenu() {
        ProductDto mapped =  convertToResource(PRODUCT);
        try {
    ...
    public void theSystemShowsTheDishesNames() {
        ProductDto mapped =  convertToResource(PRODUCT);
        try {
            Assert.assertNotNull("RESPONSE NOT NULL",responseAll);
        }catch(AssertionError e){
